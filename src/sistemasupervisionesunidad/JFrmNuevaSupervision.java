        ...
        try {
            ...
            switch (Integer.parseInt(String.valueOf(numeroDePersonas))) {
                case 1:
                    ...
                    impresion = JasperFillManager.fillReport(rutaJasperFile, parameters, new JREmptyDataSource());
                    JasperExportManager.exportReportToPdfFile(impresion, rutaGuardarReporte);
                    JasperViewer.viewReport(impresion, false);
                    parameters = null;
                    impresion = null;
                ...
                case 2:
                    ...
                    parameters.put("persona_dos", txtPersona2.getText());
                    parameters.put("cargo_persona_dos", jTxtCargoPersona2.getText());   
                    impresion = JasperFillManager.fillReport(rutaJasperFile, parameters, new JREmptyDataSource());
                    JasperExportManager.exportReportToPdfFile(impresion, rutaGuardarReporte);
                    JasperViewer.viewReport(impresion, false);
                    parameters = null;
                ...
                case 3:
                    ...
                    parameters.put("persona_dos", txtPersona2.getText());
                    parameters.put("cargo_persona_dos", jTxtCargoPersona2.getText());
                    parameters.put("persona_tres", txtPersona3.getText());
                    parameters.put("cargo_persona_tres", jTxtCargoPersona3.getText());
                    impresion = JasperFillManager.fillReport(rutaJasperFile, parameters, new JREmptyDataSource());
                    JasperExportManager.exportReportToPdfFile(impresion, rutaGuardarReporte);
                    JasperViewer.viewReport(impresion, false);
                    parameters = null;
                ...
                case 4:
                    ...
                    parameters.put("persona_tres", txtPersona3.getText());
                    parameters.put("cargo_persona_tres", jTxtCargoPersona3.getText());
                    parameters.put("persona_cuatro", txtPersona4.getText());
                    parameters.put("cargo_persona_cuatro", jTxtCargoPersona4.getText());
                    impresion= JasperFillManager.fillReport(rutaJasperFile, parameters, new JREmptyDataSource());
                    JasperExportManager.exportReportToPdfFile(impresion, rutaGuardarReporte);
                    JasperViewer.viewReport(impresion, false);
                    parameters = null;
                ...
                case 5:
                    ...
                    parameters.put("persona_cuatro", txtPersona4.getText());
                    parameters.put("cargo_persona_cuatro", jTxtCargoPersona4.getText());
                    parameters.put("persona_cinco", txtPersona5.getText());
                    parameters.put("cargo_persona_cinco", jTxtCargoPersona5.getText());
                    impresion = JasperFillManager.fillReport(rutaJasperFile, parameters, new JREmptyDataSource());
                    JasperExportManager.exportReportToPdfFile(impresion, rutaGuardarReporte);
                    JasperViewer.viewReport(impresion, false);
                    parameters = null;
                ...
                case 6:
                    ...
                    parameters.put("persona_cinco", txtPersona5.getText());
                    parameters.put("cargo_persona_cinco", jTxtCargoPersona5.getText());
                    parameters.put("persona_seis", txtPersona6.getText());
                    parameters.put("cargo_persona_seis", jTxtCargoPersona6.getText());
                    impresion = JasperFillManager.fillReport(rutaJasperFile, parameters, new JREmptyDataSource());
                    JasperExportManager.exportReportToPdfFile(impresion, rutaGuardarReporte);
                    JasperViewer.viewReport(impresion, false);
                    impresion = null;
